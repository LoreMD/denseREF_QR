...
int main( int argc, char* argv[] )
{
    ...
    // Use IPGE Gram Schmidt (Q is Q' so that it is faster)
    ...
    // Use IPGE Gram Schmid
    
    clock_t start_solve3 = clock();
    
    SPEX_QR_genGS( A, &R3, &Q3);
    ...
    printf("Q2 \n");
    SPEX_matrix_check(Q2, option); //this is the transpose of Q
    */
    //printf("Q3 \n");
    ...
    */
    ...
    double rat3 = t_qr2 / t_qr3;
    
    printf("\nIPGE QR time: \t\t\t%lf\n\n", t_qr1);
    printf("\nIPGE QR Gram-Schmidt time: \t\t%lf\n\n", t_qr2);
    printf("\nIPGE QR E&K Gram-Schmidt time: \t\t%lf\n\n", t_qr3);
    printf("\nRatio IPGE QR/ Gram-Schmidt: \t%lf\n\n", rat);
    printf("\nRatio IPGE QR/ E&K Gram-Schmidt: \t%lf\n\n", rat2);
    printf("\nRatio QR Gram-Schmidt/ E&K Gram-Schmidt: \t%lf\n\n", rat2);
    printf("\nTime to do Q^T*b: \t\t%lf\n", t_b);
...
/*
    ...
    u=(int64_t*)malloc(n*sizeof(int64_t));
